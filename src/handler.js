...
function getToken(event) {
  return parseBody(event).subject_token;
}
...
export const handler = async (event) => {
  ...
  try {
    ...
    console.log("[request] grant_type:", body.grant_type);
    console.log("[request] subject_token present:", !!body.subject_token);
    console.log("[request] subject_token_type:", body.subject_token_type);

    if (body.grant_type && body.grant_type !== GRANT_TYPE) {
